namespace SuperPUWEtty2.Scp
{
    partial class PscpBrowserPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.browserViewLocal = new SuperPUWEtty2.Scp.BrowserView();
            this.browserViewRemote = new SuperPUWEtty2.Scp.BrowserView();
            this.fileTransferView = new SuperPUWEtty2.Scp.FileTransferView();
