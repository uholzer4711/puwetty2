...
namespace SuperPUWEtty2.Properties {
    ...
    internal sealed partial class Settings {
        ...
        {
            // Get Registry Entry for PUWEtty2 Exe
            RegistryKey key = Registry.CurrentUser.OpenSubKey(@"Software\Jim Radford\SuperPUWEtty2\Settings");
            if (key != null)
            {
        ...
        public KeyboardShortcut[] LoadShortcuts()
        {
            ...
            foreach (SuperPUWEtty2Action action in Enum.GetValues(typeof(SuperPUWEtty2Action)))
            {
