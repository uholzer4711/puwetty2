...
namespace SuperPUWEtty2.Utils
{
    ...
    /// Use:
    /// --------------------------------------------------------------------------
    /// SuperPUWEtty2.exe -layout LAYOUT_NAME
    /// OR
    /// SuperPUWEtty2.exe -session SESSION_NAME
    /// OR 
    /// SuperPUWEtty2.exe -[PROTOCOL] -P PORT -l USER -pw PASSWORD -load SETTINGS HOSTNAME
    /// OR 
    /// SuperPUWEtty2.exe -l USER -pw PASSWORD -load SETTINGS PROTOCOL://HOSTNAME:port
    /// ------------
    /// Options:
    ...
    /// ------------------------------------------------------------------------------
    /// SuperPUWEtty2.exe -layout LAYOUT_NAME
    /// SuperPUWEtty2.exe -session SESSION_ID
    /// SuperPUWEtty2.exe -ssh -P 22 -l homer -pw springfield -load pp1 prod-reactor
    /// SuperPUWEtty2.exe -l peter -pw donut foobar
    /// </summary>
    public class CommandLineOptions
    {
        ...
        public SessionDataStartInfo ToSessionStartInfo()
        {
            ...
            if (this.SessionId != null)
            {
                ...
                SessionData session = SuperPUWEtty2.GetSessionById(this.SessionId);
                if (session == null)
                {
            ...
            else if (this.Host != null ||  this.PuttySession != null)
            {
                ...
                ssi = new SessionDataStartInfo
                {
                    Session = new SessionData
                    {
                        ...
                        SessionId = SuperPUWEtty2.MakeUniqueSessionId(SessionData.CombineSessionIds("CLI", this.Host)),
        ...
        public static string Usage()
        {
            ...
            sb.AppendLine("Usage:");
            sb.AppendLine("");
            sb.AppendLine("  SuperPUWEtty2.exe -session SESSION");
            sb.AppendLine("  SuperPUWEtty2.exe -layout LAYOUT");
            sb.AppendLine("  SuperPUWEtty2.exe -load SETTINGS");
            sb.AppendLine("  SuperPUWEtty2.exe -PROTO -P PORT -l USER -pw PASSWORD -load SETTINGS HOST");
            sb.AppendLine("  SuperPUWEtty2.exe -l USER -pw PASSWORD -load SETTINGS PROTO://HOST:PORT");
            sb.AppendLine();
            sb.AppendLine("Options:");
            sb.AppendLine();
            sb.AppendLine("  SESSION\t\t - Session id");
            sb.AppendLine("  LAYOUT\t\t - Layout name");
            sb.AppendLine("  SETTINGS\t - PUWEtty2 Saved Session Profile");
            ...
            sb.AppendLine();
            sb.AppendLine("  SuperPUWEtty2.exe -session nyc-qa-1");
            sb.AppendLine("  SuperPUWEtty2.exe -layout prod");
            sb.AppendLine("  SuperPUWEtty2.exe -ssh -P 22 -l homer -pw springfield -load pp1 prod-reactor");
            sb.AppendLine("  SuperPUWEtty2.exe -vnc stewie01");
            sb.AppendLine("  SuperPUWEtty2.exe -l peter -pw griffin stewie01");
            sb.AppendLine("  SuperPUWEtty2.exe -load localhost");
