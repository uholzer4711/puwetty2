...
namespace SuperPUWEtty2UnitTests.Scp
{
    /// <summary>
    ...
    {
        public static readonly string PscpLocation = ConfigurationManager.AppSettings["SuperPUWEtty2.ScpTests.PscpLocation"];
        public static readonly string UserName = ConfigurationManager.AppSettings["SuperPUWEtty2.ScpTests.UserName"];
        public static readonly string Password = ConfigurationManager.AppSettings["SuperPUWEtty2.ScpTests.Password"];
        public static readonly string KnownHost = ConfigurationManager.AppSettings["SuperPUWEtty2.ScpTests.KnownHost"];
        public static readonly string UnKnownHost = ConfigurationManager.AppSettings["SuperPUWEtty2.ScpTests.UnKnownHost"];
